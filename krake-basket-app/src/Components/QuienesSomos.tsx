    ...
    <div className="space-y-12">
      ...
      {editMode && isAdmin ? (
        ...
        <div className="space-y-6">
          ...
          {/* ======================================================= */}
          <div className="bg-gray-950 border border-gray-800 rounded-2xl p-6 md:p-8 shadow-xl text-center space-y-4">
            <div>
              <h3 className="text-xl font-bold text-white uppercase tracking-wider">📄 Reglamento Krack League 3x3</h3>
              <p className="text-sm text-gray-400 mt-1">Descargá las reglas oficiales del torneo.</p>
            </div>

            <a
              href={REGLAMENTO_URL}
              download="Reglamento-Krack-League-3x3.pdf"
              className="inline-flex items-center gap-2 bg-[#05fcfe] hover:bg-cyan-400 text-black font-bold text-sm py-3 px-6 rounded-lg transition-colors"
            >
